...
public final class RuntimeOptions {
  ...
  public static final String ENABLE_CACHE_STATS = optionName("enableCacheCounters");
  public static final OptionKey<Boolean> ENABLE_CACHE_STATS_KEYS = new OptionKey<>(false);
  public static final OptionDescriptor ENABLE_CACHE_STATS_DESCRIPTOR =
      OptionDescriptor.newBuilder(ENABLE_CACHE_STATS_KEYS, ENABLE_CACHE_STATS).build();
