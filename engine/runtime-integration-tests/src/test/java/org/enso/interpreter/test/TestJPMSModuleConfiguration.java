 ...
 * Moreover, there are other testing facilities that require reflective access to the classes
 * inside `org.enso.runtime` module.
 * One of the facilities is
 * {@link com.oracle.truffle.host.HostClassDesc#getLookup(Class, HostClassCache) truffle host lookup}.
 */
public class TestJPMSModuleConfiguration {
  ...
  public void testPackagesArePatchedToRuntimeModule() {
    ...
    assertThat(
        "Test packages are patched to org.enso.runtime module",
        modName,
        is("org.enso.runtime"));
  }
