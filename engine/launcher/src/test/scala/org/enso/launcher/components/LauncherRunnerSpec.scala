...
class LauncherRunnerSpec extends RuntimeVersionManagerTest with FlakySpec {
  private val defaultEngineVersion = Version.of(0, 0, 0, "default")
  ...
  def makeFakeRunner(
    ...
    val configurationManager =
      new GlobalRunnerConfigurationManager(
        ...
        override def defaultVersion: Version = defaultEngineVersion
      }
  ...
  "Runner" should {
    ...
    "run repl in project context" in {
      ...
      val version = Version.of(0, 0, 0, "repl-test")
      ...
      val overridden = Version.of(0, 0, 0, "overridden")
    ...
    "run language server" in {
      ...
      val version     = Version.of(0, 0, 0, "language-server-test")
      val projectPath = getTestDirectory / "project"
      newProject("test", projectPath, version)
    ...
    "run a project" in {
      ...
      val version        = Version.of(0, 0, 0, "run-test")
      val projectPath    = getTestDirectory / "project"
      val normalizedPath = projectPath.toAbsolutePath.normalize.toString
      newProject("test", projectPath, version)
    ...
    "get project version inside of project" in {
      val version      = Version.of(0, 0, 0, "version-test")
      val projectPath  = getTestDirectory / "project"
      val name         = "Testname"
