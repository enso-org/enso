 ...
 * expression into it.
 * <p>
 * The expression inserted into the method contains some undefined identifiers and thus, should fail
 * to compile.
 */
...
public class InlineCompilerErrorBenchmark {
  ...
  public void setup() throws IOException {
    ...
    var longExpression = InlineContextUtils.createLongExpression(inlineSource.localVarNames(), LONG_EXPR_SIZE);
