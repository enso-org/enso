...
object AliasAnalysisInfo {
  ...
  object Scope {
     ...
     */
    sealed case class Root(override val graph: AliasAnalysisGraph) extends Scope {
     ...
     */
    sealed case class Child(override val graph: AliasAnalysisGraph, scope: AliasAnalysisGraph.Scope)
      extends Scope {
   ...
   */
  sealed case class Occurrence(override val graph: AliasAnalysisGraph, id: AliasAnalysisGraph.Id)
