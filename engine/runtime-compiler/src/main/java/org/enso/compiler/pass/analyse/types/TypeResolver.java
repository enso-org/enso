 ...
 * and building complex types from parts - e.g. function type.
 */
class TypeResolver {
  ...
  TypeRepresentation buildAtomConstructorType(TypeRepresentation.TypeObject parentType, BindingsMap.Cons constructor) {
