...
public class System {
    ...
    private final static Text LINUX = Text.create("linux");
    private final static Text MACOS = Text.create("macos");
    private final static Text WINDOWS = Text.create("windows");
    private final static Text UNKNOWN = Text.create("unknown");
    ...
    @Builtin.WrapException(from = InterruptedException.class, to = PanicException.class, propagate = true)
    @CompilerDirectives.TruffleBoundary
    public static Atom createProcess(Context ctx, Object command, Array arguments, Object input, boolean redirectIn,
                                     boolean redirectOut,
                                     boolean redirectErr,
                                     @Cached ExpectStringNode expectStringNode) throws IOException, InterruptedException {
