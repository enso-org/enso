...
public final class EnsoLanguage extends TruffleLanguage<EnsoContext> {
  ...
  protected EnsoContext createContext(Env env) {
    ...
    boolean cacheStatsEnabled = env.getOptions().get(RuntimeOptions.ENABLE_CACHE_STATS_KEYS);
    var cacheStats = cacheStatsEnabled ? CacheStatistics.create() : null;
    ...
    EnsoContext context =
        new EnsoContext(
            this, env, notificationHandler, lockManager, distributionManager, cacheStats);
