...
public class RoundHelpers {
    ...
    @TruffleBoundary
    public static void decimalPlacesOutOfRangePanic(Node node, long decimalPlaces) throws PanicException {
        String msg =
        ...
        throw new PanicException(builtins.error().makeUnsupportedArgumentsError(new Object[]{decimalPlaces}, msg), node);
    }
    ...
    public static void argumentOutOfRangePanic(Node node, double n) throws PanicException {
        String msg =
                "Error: `round` can only accept values between "
                        ...
                        + n;
        Builtins builtins = EnsoContext.get(node).getBuiltins();
        throw new PanicException(builtins.error().makeUnsupportedArgumentsError(new Object[]{n}, msg), node);
    }
