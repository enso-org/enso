...
public abstract class RunStateNode extends Node {
  ...
  Stateful doEmpty(
    ...
    Object result = thunkExecutorNode.executeThunk(computation, localStateMap, BaseNode.TailStatus.NOT_TAIL).getValue();
  ...
  Stateful doSingletonSameKey(
    ...
    Stateful res = thunkExecutorNode.executeThunk(computation, localStateContainer, BaseNode.TailStatus.NOT_TAIL);
  ...
  Stateful doSingletonNewKeyCached(
    ...
    Stateful res = thunkExecutorNode.executeThunk(computation, localStateMap, BaseNode.TailStatus.NOT_TAIL);
