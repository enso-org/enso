...
final class TruffleCompilerContext implements CompilerContext {
  ...
  private final Mock serializationPool;
  ...
  private static interface Mock {
    ...
    public Future<Boolean> submitTask(Callable<Boolean> task, boolean createThreadAllowed, QualifiedName toQualifiedName);
  }
}