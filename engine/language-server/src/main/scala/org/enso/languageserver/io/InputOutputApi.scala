...
object InputOutputApi {
  ...
  case object StandardOutputAppended
    ...
    implicit
    val hasParams: HasParams.Aux[this.type, StandardOutputAppended.Params] =
      new HasParams[this.type] {
  ...
  case object StandardErrorAppended extends Method("io/standardErrorAppended") {
    ...
    implicit
    val hasParams: HasParams.Aux[this.type, StandardErrorAppended.Params] =
      new HasParams[this.type] {
  ...
  case object FeedStandardInput extends Method("io/feedStandardInput") {
    ...
    implicit val hasParams: HasParams.Aux[this.type, FeedStandardInput.Params] =
      new HasParams[this.type] {
