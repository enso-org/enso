...
impl Paths {
    ...
    /// Path to the manifest yaml generated by `sbt`.
    ...
    /// Path to the edition YAML template.
    pub fn edition_template(&self) -> PathBuf {
        self.repo_root.distribution.edition_template_yaml.to_path_buf()
    }
