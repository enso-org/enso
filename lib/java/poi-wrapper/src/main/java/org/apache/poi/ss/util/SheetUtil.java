...
public class SheetUtil {
  ...
  private static double getCellWidth(
      int defaultCharWidth, int colspan, CellStyle style, double minWidth, AttributedString str) {
    ...
    // whitespace around
    //     * the unrotated top and bottom of the text that normally wouldn't be present if unscaled,
    // but
  ...
  private static void copyAttributes(
      ...
      @SuppressWarnings("SameParameterValue") int startIdx,
      int endIdx) {
    // str.addAttribute(TextAttribute.FAMILY, font.getFontName(), startIdx, endIdx);
    // str.addAttribute(TextAttribute.SIZE, (float)font.getFontHeightInPoints());
    // if (font.getBold()) str.addAttribute(TextAttribute.WEIGHT, TextAttribute.WEIGHT_BOLD,
    // startIdx, endIdx);
    // if (font.getItalic() ) str.addAttribute(TextAttribute.POSTURE, TextAttribute.POSTURE_OBLIQUE,
    // startIdx, endIdx);
    // if (font.getUnderline() == Font.U_SINGLE ) str.addAttribute(TextAttribute.UNDERLINE,
