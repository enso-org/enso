...
/**
 * In the `runtime/Test` testing suite, {@link }org.enso.logging.service.logback.test.provider.TestLogProvider} should be among the
...
public class TestLogProviderOnClasspath {
  ...
  public void testLogProviderIsInUnnamedModule() {
    ...
    try {
      testLogProviderClass = Class.forName(
