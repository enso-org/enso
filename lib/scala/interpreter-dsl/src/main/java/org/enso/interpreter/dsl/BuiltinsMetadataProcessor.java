...
public abstract class BuiltinsMetadataProcessor extends AbstractProcessor {
    ...
    protected abstract void storeMetadata(Writer writer, Map<String, String> pastEntries) throws IOException;
        ...
        if (roundEnv.processingOver()) {
            ...
            try {
                ...
                try (InputStream resource = existingFile.openInputStream()) {
                    pastEntries = new BufferedReader(new InputStreamReader(resource, StandardCharsets.UTF_8)).
                            lines().
