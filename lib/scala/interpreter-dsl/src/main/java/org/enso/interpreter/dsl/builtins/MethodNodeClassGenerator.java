...
public abstract class MethodNodeClassGenerator {
    ...
    public MethodNodeClassGenerator(ClassName builtinNode, ClassName ownerClazz, ClassName stdlibOwner, Map<String, Integer> builtinTypesParamCount) {
    ...
    protected SafeWrapException[] wrapExceptions(ProcessingEnvironment processingEnv, Element element) {
    ...
    public void generate(ProcessingEnvironment processingEnv, String methodName, String description, String ownerMethodName) throws IOException {
        ...
        try (PrintWriter out = new PrintWriter(gen.openWriter())) {
            ...
            for (String line : methodsGen(processingEnv).generate(ownerMethodName, ownerClazz.name(), builtinTypesParamCount)) {
                out.println("  " + line);
            }
            out.println();
            out.println("}");
     ...
     *
     * @return true if the method node should be abstract, false if a concrete class should be generated
     */
