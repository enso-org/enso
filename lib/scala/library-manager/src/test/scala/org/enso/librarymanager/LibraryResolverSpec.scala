...
class LibraryResolverSpec
  ...
  "LibraryResolver" should {
    ...
    val parentEdition = Editions.Resolved.Edition(
      parent        = None,
      engineVersion = Some(Version.of(0, 0, 0)),
    ...
    "correctly resolve libraries based on the edition" in {
      ...
      LibraryVersion.Published(Version.of(4, 5, 6), mainRepo)
      ...
      resolver
        ...
        .rightValue shouldEqual
      LibraryVersion.Published(Version.of(1, 0, 0), mainRepo)
      ...
      resolver
        ...
        .rightValue shouldEqual
      LibraryVersion.Published(Version.of(2, 0, 0), customRepo)
