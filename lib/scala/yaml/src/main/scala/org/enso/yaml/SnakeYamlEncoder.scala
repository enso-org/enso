...
trait SnakeYamlEncoder[T] {
  ...
  /**
    ...
    */
  protected def toMap(key: String, value: Object): java.util.Map[String, Object] = {
  ...
  /**
    ...
    * @return a map
    */
  protected def toMap(elements: java.util.List[(String, Object)]): java.util.Map[String, Object] = {
...
object SnakeYamlEncoder {
  ...
  implicit def stringEncoderYaml: SnakeYamlEncoder[String] = new SnakeYamlEncoder[String] {
    override def encode(value: String): Object = {
       value
    }
  }

  implicit def booleanEncoderYaml: SnakeYamlEncoder[Boolean] = new SnakeYamlEncoder[Boolean] {
    override def encode(value: Boolean): Object = {
      value.toString
    }
  }

  implicit def iterableEncoderYaml[CC[X] <: IterableOnce[X], T](implicit elemEncoder: SnakeYamlEncoder[T]): SnakeYamlEncoder[CC[T]] = new SnakeYamlEncoder[CC[T]] {
