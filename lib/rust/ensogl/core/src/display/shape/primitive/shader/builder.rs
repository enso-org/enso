...
const ID_ENCODING_OVERFLOW_ERR: &str = include_str!("../glsl/error_codes/id_encoding_overflow.txt");
...
fn make_glsl_prelude() -> String {
    ...
    let err_codes = format!("const int ID_ENCODING_OVERFLOW_ERROR = {};", ID_ENCODING_OVERFLOW_ERR);
