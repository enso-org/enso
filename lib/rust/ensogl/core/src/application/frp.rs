...
macro_rules! test_2 {
    (
        ...
        #[allow(unused_parens)]
        impl $($ctx)* $data_name <$($param)*> {
            pub fn new($net: &$crate::frp::Network, $($arg: $arg_tp),*) -> Self {
    ...
    ({
        ...
        pub mod private {
            ...
            $crate::test_2! {
                ...
                pub fn new(network, public_input: (&api::public::Input<$($param)*>)) {
                    $crate::frp::extend! { $input_opts network
            ...
            //             $($out_field <- any_mut();)*
            //         }
            //         Self { _phantom_type_args, $($out_field),* }
            //     }
            // }
        }
    };
