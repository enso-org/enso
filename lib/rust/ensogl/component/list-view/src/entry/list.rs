...
where E::Model: Default
{
    ...
    /// Set params used in the displayed entries. Any entries newly created by the function will
    /// use the styles located at the `style_prefix` path in the application's style sheet.
    ///
