...
//!
//! A Component Group View displays a header (containing the name of a group of Enso components)
//! above a list of entries (names of the components belonging to that group).
