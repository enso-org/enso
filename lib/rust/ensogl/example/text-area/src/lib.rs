...
fn init(app: Application) {
    ...
    area.set_dilate_bytes(Range::new(4.bytes(), 6.bytes()), style::Dilate(0.02));
    area.set_dilate_bytes(Range::new(7.bytes(), 15.bytes()), style::Dilate(0.04));
    area.set_dilate_bytes(Range::new(24.bytes(), 26.bytes()), style::Dilate(0.02));
    area.set_dilate_bytes(Range::new(37.bytes(), 41.bytes()), style::Dilate(0.05));
    area.set_dilate_bytes(Range::new(55.bytes(), 56.bytes()), style::Dilate(0.03));
