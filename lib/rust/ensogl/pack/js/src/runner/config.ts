...
export class OptionGroups {
    static applicationLoader = 'Application Loader Options'
    static applicationStartup = 'Application Startup Options'
    static debug = 'Debug Options'
}
...
export class Params {
    ...
    pkgWasmUrl = new Param<string>({
        group: OptionGroups.applicationLoader,
        type: 'string',
        default: 'pkg.wasm',
    ...
    entry = new Param<string>({
        group: OptionGroups.applicationStartup,
        type: 'string',
