...
fn application() {
    test_block!("a b c",
        @"(BodyBlock #((ExpressionStatement () (Call (App (App (Ident a) (Ident b)) (Ident c))))))");
}

#[test]
fn parentheses() {
    test_block!("(a b)",
        @"(BodyBlock #((ExpressionStatement () (Group (Call (App (Ident a) (Ident b)))))))");
    test_block!("x)",
    ...
    test_block!("(a) (b)",
        @"(BodyBlock #((ExpressionStatement () (Call (App (Group (Ident a)) (Group (Ident b)))))))");
    test_block!("((a b) c)",
        @"(BodyBlock #((ExpressionStatement () (Group (Call (App (Group (Call (App (Ident a) (Ident b)))) (Ident c)))))))");
    test_block!("(a).b",
...
fn if_then_else_chained_block() {
    ...
    test_block!("if True then True else False\n    . to_text\n    . as_value\n    . done 42",
        @r#"(BodyBlock #((ExpressionStatement () (OperatorBlockApplication (MultiSegmentApp #(((Ident if) (Ident True)) ((Ident then) (Ident True)) ((Ident else) (Ident False)))) #(((Ok ".") (Ident to_text)) ((Ok ".") (Ident as_value)) ((Ok ".") (Call (App (Ident done) (Number () "42" ()))))) #()))))"#);
}
...
fn function_inline_simple_args() {
    ...
    test_module!("foo _ = x",
        @"(BodyBlock #((Function () #() () () (Ident foo) #((() (Wildcard) () ())) () (Ident x))))");
    test_module!("foo a =x",
        @"Each operator on the left side of an assignment operator must be applied to two operands, with the same spacing on each side: (BodyBlock #((Invalid)))");
}
...
fn ignored_arguments() {
    test_module!("f _ = x",
        @"(BodyBlock #((Function () #() () () (Ident f) #((() (Wildcard) () ())) () (Ident x))))");
    test_module!("f ~_ = x",
        @r#"(BodyBlock #((Function () #() () () (Ident f) #(("~" (Wildcard) () ())) () (Ident x))))"#);
}
...
fn ignored_argument_patterns() {
    test_block!("_ -> x",
        @r#"(BodyBlock #((ExpressionStatement () (OprApp (Wildcard) (Ok "->") (Ident x)))))"#);
    test_block!("_-> x",
        @r#"(BodyBlock #((ExpressionStatement () (OprApp (Wildcard) (Ok "->") (Ident x)))))"#);
    test_block!("_ = x", @"(BodyBlock #((Assignment () (Wildcard) (Ident x))))");
    test_block!("_= x", @"(BodyBlock #((Assignment () (Wildcard) (Ident x))))");
    test_block!("\\_ -> x",
        @r#"(BodyBlock #((ExpressionStatement () (Lambda "\\" #((() (Wildcard) () ())) "->" (Ident x)))))"#);
    test_block!("\\_-> x",
        @r#"(BodyBlock #((ExpressionStatement () (Lambda "\\" #((() (Wildcard) () ())) "->" (Ident x)))))"#);
}
...
fn named_arguments() {
    test_block!("f x=y",
        @"(BodyBlock #((ExpressionStatement () (Call (NamedApp (Ident f) x (Ident y))))))");
    test_block!("f (x = y)",
        @"(BodyBlock #((ExpressionStatement () (Call (NamedApp (Ident f) x (Ident y))))))");
    test_block!("f (x = y",
        @"Unclosed parenthesis in expression: (BodyBlock #((ExpressionStatement () (Invalid))))");
    ...
    test_block!("(x a=b)",
        @"(BodyBlock #((ExpressionStatement () (Group (Call (NamedApp (Ident x) a (Ident b)))))))");
    test_block!("(x a=b.c)",
        @"(BodyBlock #((ExpressionStatement () (Group (Call (NamedApp (Ident x) a (PropertyAccess (Ident b) c)))))))");
    test_block!("catch handler=exc->\n    throw",
        @r#"(BodyBlock #((ExpressionStatement () (Call (NamedApp (Ident catch) handler (OprApp (Ident exc) (Ok "->") (BodyBlock #((ExpressionStatement () (Ident throw))))))))))"#);
    test_block!("sort by=x-> y-> compare x y",
        @r#"(BodyBlock #((ExpressionStatement () (Call (NamedApp (Ident sort) by (OprApp (Ident x) (Ok "->") (OprApp (Ident y) (Ok "->") (Call (App (App (Ident compare) (Ident x)) (Ident y))))))))))"#);
    test_block!("sort by=(<) xs",
        @r#"(BodyBlock #((ExpressionStatement () (Call (App (NamedApp (Ident sort) by (Group (OprApp () (Ok "<") ()))) (Ident xs))))))"#);
    test_block!("sort by=(x-> x) y-> compare x y",
        @r#"(BodyBlock #((ExpressionStatement () (Call (App (NamedApp (Ident sort) by (Group (OprApp (Ident x) (Ok "->") (Ident x)))) (OprApp (Ident y) (Ok "->") (Call (App (App (Ident compare) (Ident x)) (Ident y)))))))))"#);
    test_block!("sort by=(x-> x) 1",
        @r#"(BodyBlock #((ExpressionStatement () (Call (App (NamedApp (Ident sort) by (Group (OprApp (Ident x) (Ok "->") (Ident x)))) (Number () "1" ()))))))"#);
    test_block!("foo to=",
    ...
    test_block!("foo . bar baz=quux",
        @"(BodyBlock #((ExpressionStatement () (Call (NamedApp (PropertyAccess (Ident foo) bar) baz (Ident quux))))))");
}
...
fn operator_block() {
    test_block!(["value = nums", "    * each random", "    + constant"].join("\n"),
        @r#"(BodyBlock #((Assignment () (Ident value) (OperatorBlockApplication (Ident nums) #(((Ok "*") (Call (App (Ident each) (Ident random)))) ((Ok "+") (Ident constant))) #()))))"#);
}
...
fn argument_block_precedence() {
    ...
    test_module!(["f 1 n=2", "    3", "    4"].join("\n"),
        @r#"(BodyBlock #((ExpressionStatement () (ArgumentBlockApplication (Call (NamedApp (App (Ident f) (Number () "1" ())) n (Number () "2" ()))) #((Number () "3" ()) (Number () "4" ()))))))"#);
    // Argument block has lower precedence than assignment.
    test_block!(["x = f 1 2", "    3", "    4"].join("\n"),
        @r#"(BodyBlock #((Assignment () (Ident x) (ArgumentBlockApplication (Call (App (App (Ident f) (Number () "1" ())) (Number () "2" ()))) #((Number () "3" ()) (Number () "4" ()))))))"#);
}
...
fn dot_operator_precedence() {
    test_block!("x y . f v",
        @"(BodyBlock #((ExpressionStatement () (Call (App (PropertyAccess (Call (App (Ident x) (Ident y))) f) (Ident v))))))");
}
...
fn template_functions() {
    ...
    test_block!("_+1 + x",
        @r#"(BodyBlock #((ExpressionStatement () (TemplateFunction (OprApp (OprApp (Wildcard) (Ok "+") (Number () "1" ())) (Ok "+") (Ident x))))))"#);
}
...
fn minus_unary() {
    test_block!("f -x",
        @r#"(BodyBlock #((ExpressionStatement () (Call (App (Ident f) (UnaryOprApp "-" (Ident x)))))))"#);
    test_block!("-x",
...
fn autoscope_operator() {
    ...
    test_block!("x = f .. True",
        @"The autoscope operator must be applied to an identifier: (BodyBlock #((Assignment () (Ident x) (Call (App (App (Ident f) (Invalid)) (Ident True))))))");
    test_block!("x = f (.. ..)",
    ...
    test_block!("x = f (.. True)",
        @"The autoscope operator must be applied to an identifier: (BodyBlock #((Assignment () (Ident x) (Call (App (Ident f) (Group (Call (App (Invalid) (Ident True)))))))))");
    test_block!("x = True..",
        @"Space required between terms: (BodyBlock #((Assignment () (Ident x) (Invalid))))");
    ...
    test_block!("x = .. True",
        @"The autoscope operator must be applied to an identifier: (BodyBlock #((Assignment () (Ident x) (Call (App (Invalid) (Ident True))))))");
    test_block!("x : .. True",
        @r#"The autoscope operator must be applied to an identifier: (BodyBlock #((ExpressionStatement () (TypeAnnotated (Ident x) ":" (Call (App (Invalid) (Ident True)))))))"#);
}
...
fn type_annotations() {
    ...
    test_block!("val = foo (x : Int)",
        @r#"(BodyBlock #((Assignment () (Ident val) (Call (App (Ident foo) (Group (TypeAnnotated (Ident x) ":" (Ident Int))))))))"#);
    test_block!("(x : My_Type _)",
        @r#"(BodyBlock #((ExpressionStatement () (Group (TypeAnnotated (Ident x) ":" (Call (App (Ident My_Type) (TemplateFunction (Wildcard)))))))))"#);
...
fn new_lambdas() {
    ...
    test_block!("\\ v ->\n    v",
        @r#"(BodyBlock #((ExpressionStatement () (Lambda "\\" #((() (Ident v) () ())) "->" (BodyBlock #((ExpressionStatement () (Ident v))))))))"#);
    test_block!("f \\ v ->\n    v",
        @r#"(BodyBlock #((ExpressionStatement () (Call (App (Ident f) (Lambda "\\" #((() (Ident v) () ())) "->" (BodyBlock #((ExpressionStatement () (Ident v))))))))))"#);
    test_block!(r#"\a b -> x"#,
    ...
    test_block!(r#"\a (b = f _ 1) -> f a"#,
        @r#"(BodyBlock #((ExpressionStatement () (Lambda "\\" #((() (Ident a) () ()) (() (Ident b) () ((Call (App (App (Ident f) (TemplateFunction (Wildcard))) (Number () "1" ())))))) "->" (Call (App (Ident f) (Ident a)))))))"#);
    test_block!("\\",
        @"Invalid macro invocation: (BodyBlock #((ExpressionStatement () (Invalid))))");
    test_block!("\\ v",
        @"Invalid macro invocation: (BodyBlock #((ExpressionStatement () (Call (App (Invalid) (Ident v))))))");
    test_block!("\\v",
        @"Space required between terms: (BodyBlock #((ExpressionStatement () (Invalid))))");
    test_block!("\\v->",
...
fn old_lambdas() {
    ...
    test_block!("x ->\n y",
        @r#"(BodyBlock #((ExpressionStatement () (OprApp (Ident x) (Ok "->") (BodyBlock #((ExpressionStatement () (Ident y))))))))"#);
    test_block!("f x->\n y",
        @r#"(BodyBlock #((ExpressionStatement () (Call (App (Ident f) (OprApp (Ident x) (Ok "->") (BodyBlock #((ExpressionStatement () (Ident y))))))))))"#);
    test_block!("x->y-> z",
        @r#"(BodyBlock #((ExpressionStatement () (OprApp (Ident x) (Ok "->") (OprApp (Ident y) (Ok "->") (Ident z))))))"#);
    test_block!("foo = x -> (y = bar x) -> x + y",
        @r#"(BodyBlock #((Assignment () (Ident foo) (OprApp (Ident x) (Ok "->") (OprApp (Group (OprApp (Ident y) (Ok "=") (Call (App (Ident bar) (Ident x))))) (Ok "->") (OprApp (Ident x) (Ok "+") (Ident y)))))))"#);
}
...
fn pattern_irrefutable() {
    ...
    test_block!("Vector _ = x",
        @"(BodyBlock #((Assignment () (App (Ident Vector) (Wildcard)) (Ident x))))");
    test_block!("X.y = z",
...
fn case_expression() {
    ...
    test_block!(["case self of", "    Vector_2d -> x", "    _ -> x"].join("\n"),
        @r#"(BodyBlock #((ExpressionStatement () (CaseOf (Ident self) #(((() (Ident Vector_2d) "->" (Ident x))) ((() (Wildcard) "->" (Ident x))))))))"#);
    test_block!(["case foo of", "    v:My_Type -> x", "    v:(My_Type _ _) -> x"].join("\n"),
        @r#"(BodyBlock #((ExpressionStatement () (CaseOf (Ident foo) #(((() (TypeAnnotated (Ident v) ":" (Ident My_Type)) "->" (Ident x))) ((() (TypeAnnotated (Ident v) ":" (Group (Call (App (App (Ident My_Type) (TemplateFunction (Wildcard))) (TemplateFunction (Wildcard)))))) "->" (Ident x))))))))"#);
}
...
fn case_by_type() {
    ...
    test_case!("v : A -> _ + x",
        @r#"(BodyBlock #((ExpressionStatement () (CaseOf (Ident foo) #(((() (TypeAnnotated (Ident v) ":" (Ident A)) "->" (TemplateFunction (OprApp (Wildcard) (Ok "+") (Ident x))))))))))"#);
}
...
fn suspended_default_arguments_in_expression() {
    test_block!("c = self.value ...",
        @"(BodyBlock #((Assignment () (Ident c) (Call (App (PropertyAccess (Ident self) value) (SuspendedDefaultArguments))))))");
    test_block!("c = self.value...",
        @"(BodyBlock #((Assignment () (Ident c) (Call (App (PropertyAccess (Ident self) value) (SuspendedDefaultArguments))))))");
}
...
fn at_operator() {
    ...
    test_module!("foo@bar",
        @"Space required between terms: (BodyBlock #((ExpressionStatement () (Invalid))))");
    test_block!("foo @ bar",
        @"Operator must be applied to an operand: (BodyBlock #((ExpressionStatement () (Call (App (App (Ident foo) (Invalid)) (Ident bar))))))");
    test_module!("foo @ bar",
        @"Operator must be applied to an operand: (BodyBlock #((ExpressionStatement () (Call (App (App (Ident foo) (Invalid)) (Ident bar))))))");
}
...
fn annotations() {
    test_module!("@on_problems P.g\nselect_columns : Text -> Table\nselect_columns text = to_table text",
        @r#"(BodyBlock #((Function () #(((on_problems (PropertyAccess (Ident P) g)) #(()))) ((Ident select_columns) ":" (OprApp (Ident Text) (Ok "->") (Ident Table))) () (Ident select_columns) #((() (Ident text) () ())) () (Call (App (Ident to_table) (Ident text))))))"#);
    test_module!("@a\n@b 1 + 1\nf x = x",
    ...
    test_module!("@` foo\nid x = x",
        @"Space required between terms: (BodyBlock #((ExpressionStatement () (Call (App (Invalid) (Ident foo)))) (Function () #() () () (Ident id) #((() (Ident x) () ())) () (Ident x))))");
}
...
fn inline_builtin_annotations() {
    test_block!("@Tail_Call go t",
        @"(BodyBlock #((ExpressionStatement () (AnnotatedBuiltin Tail_Call #() (Call (App (Ident go) (Ident t)))))))");
    test_block!("@Tail_Call go (x = y)",
        @"(BodyBlock #((ExpressionStatement () (AnnotatedBuiltin Tail_Call #() (Call (NamedApp (Ident go) x (Ident y)))))))");
    ...
    test_block!("map _-> @Tail_Call f",
        @r#"(BodyBlock #((ExpressionStatement () (Call (App (Ident map) (OprApp (Wildcard) (Ok "->") (AnnotatedBuiltin Tail_Call #() (Ident f))))))))"#);
}
...
fn freeze() {
    ...
    test_block!("FREEZE x.f y",
        @"(BodyBlock #((ExpressionStatement () (MultiSegmentApp #(((Ident FREEZE) (Call (App (PropertyAccess (Ident x) f) (Ident y)))))))))");
}
...
fn skip() {
    ...
    test_block!("SKIP x.f y",
        @"(BodyBlock #((ExpressionStatement () (MultiSegmentApp #(((Ident SKIP) (Call (App (PropertyAccess (Ident x) f) (Ident y)))))))))");
}
...
fn statement_in_expression_context() {
    ...
    test_block!("(y = z) x",
        @"Invalid use of syntactic operator in expression: (BodyBlock #((ExpressionStatement () (Call (App (Group (Invalid)) (Ident x))))))");
    test_block!("(f x = x)",
        @"Invalid use of syntactic operator in expression: (BodyBlock #((ExpressionStatement () (Group (Invalid)))))");
    test_block!("y = f x = x",
...
fn space_required() {
    test_block!("foo = if cond.x else.y",
        @"Invalid macro invocation: (BodyBlock #((Assignment () (Ident foo) (Call (App (App (Invalid) (PropertyAccess (Ident cond) x)) (PropertyAccess (Ident else) y))))))");
}
...
fn invalid_unspaced_operator_sequence() {
    ...
    test_block!("x = y +- z",
        @r#"Operator must be applied to an operand: (BodyBlock #((Assignment () (Ident x) (Call (App (App (Ident y) (OprApp () (Ok "+") (Invalid))) (Ident z))))))"#);
    ...
    test_block!("x = +- z",
        @r#"Operator must be applied to an operand: (BodyBlock #((Assignment () (Ident x) (Call (App (OprApp () (Ok "+") (Invalid)) (Ident z))))))"#);
    expect_multiple_operator_error("x =-");
...
fn property_access_simple() {
    test_block!("foo.bar", @"(BodyBlock #((ExpressionStatement () (PropertyAccess (Ident foo) bar))))");
    test_block!("foo . bar", @"(BodyBlock #((ExpressionStatement () (PropertyAccess (Ident foo) bar))))");
}
...
fn property_access_lambdas() {
    ...
    test_block!(". log",
        @"(BodyBlock #((ExpressionStatement () (PropertyAccess () log))))");
    test_block!("_.foo",
        @"(BodyBlock #((ExpressionStatement () (TemplateFunction (PropertyAccess (Wildcard) foo)))))");
    test_block!("_ . foo",
        @"(BodyBlock #((ExpressionStatement () (TemplateFunction (PropertyAccess (Wildcard) foo)))))");
}
...
fn property_access_invalid() {
    ...
    test_block!("op._.something",
        @"Invalid use of syntactic operator in expression: (BodyBlock #((ExpressionStatement () (TemplateFunction (PropertyAccess (Invalid) something)))))");
    test_block!("x. length",
        @"Invalid use of syntactic operator in expression: (BodyBlock #((ExpressionStatement () (Call (App (Invalid) (Ident length))))))");
    test_block!("x.('p')",
        @"Invalid use of syntactic operator in expression: (BodyBlock #((ExpressionStatement () (Invalid))))");
    test_block!("Console.",
        @"Invalid use of syntactic operator in expression: (BodyBlock #((ExpressionStatement () (Invalid))))");
...
fn nonsense_inputs() {
    ...
    test_module!("'`'\nx `y`\nz",
        @"Space required between terms: (BodyBlock #((ExpressionStatement () (Invalid)) (ExpressionStatement () (Call (App (Ident x) (Invalid)))) (ExpressionStatement () (Ident z))))");
    test_module!("if (asGuestValue\n  a",
        @"Invalid macro invocation: (BodyBlock #((ExpressionStatement () (ArgumentBlockApplication (Call (App (Invalid) (Invalid))) #((Ident a))))))");
    test_module!("foo(\n  a",
