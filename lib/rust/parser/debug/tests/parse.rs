...
fn type_constructors() {
    ...
    test_module!("type Foo\n Bar (a : B = C.D)",
        @r#"(BodyBlock #((TypeDef Foo #() #((ConstructorDefinition () #() () Bar #((() (Ident a) (":" (Ident B)) ((Call (PropertyAccess (Ident C) D))))) #())))))"#);
...
fn type_operator_methods() {
    test_module!([ "type Foo",
        ...
        @r#"(BodyBlock #((TypeDef Foo #() #((Function () #() ((Ident +) ":" (OprApp (Ident Foo) (Ok "->") (OprApp (Ident Foo) (Ok "->") (Call (Ident Foo))))) () (Ident +) #((() (Ident self) () ()) (() (Ident b) () ())) () (Call (Ident b))) (Function () #() ((PropertyAccess (Ident Foo) +) ":" (Ident Foo)) () (PropertyAccess (Ident Foo) +) #((() (Ident self) () ()) (() (Ident b) () ())) () (Call (Ident b)))))))"#);
    test_block!("Any.==",
        @"(BodyBlock #((ExpressionStatement () (Call (PropertyAccess (Ident Any) ==)))))");
    test_block!("x.-y",
        @"Space required between terms: (BodyBlock #((ExpressionStatement () (Invalid))))");
    test_block!("x.-1",
        @"Space required between terms: (BodyBlock #((ExpressionStatement () (Invalid))))");
...
fn complex_arguments() {
    ...
    test_module!("f ((x:Number=1)) = x",
        @"Unexpected operator in parenthesized argument definition clause: (BodyBlock #((Function () #() () () (Ident f) #((() (Invalid) () ())) () (Call (Ident x)))))");
    test_module!("f (x : Number)=1 = x",
        @r#"(BodyBlock #((Function () #() () () (Ident f) #((() (Ident x) (":" (Ident Number)) ((Number () "1" ())))) () (Call (Ident x)))))"#);
    test_module!("f (x:Number = 1) = x",
        @r#"(BodyBlock #((Function () #() () () (Ident f) #((() (Ident x) (":" (Ident Number)) ((Number () "1" ())))) () (Call (Ident x)))))"#);
...
fn argument_blocks() {
    test_block!("foo\n    bar",
        @"(BodyBlock #((ExpressionStatement () (ArgumentBlockApplication (Call (Ident foo)) #((Call (Ident bar)))))))");
    test_block!("value = foo\n    bar",
        @"(BodyBlock #((Assignment () (Ident value) (ArgumentBlockApplication (Call (Ident foo)) #((Call (Ident bar)))))))");
    test_block!(["value = foo", "    +x", "    bar"].join("\n"),
        @r#"(BodyBlock #((Assignment () (Ident value) (ArgumentBlockApplication (Call (Ident foo)) #((OprApp () (Ok "+") (Call (Ident x))) (Call (Ident bar)))))))"#);
}
...
fn dot_operator_precedence() {
    test_block!("x y . f v",
        @"(BodyBlock #((ExpressionStatement () (Call (App (PropertyAccess (App (Ident x) (Call (Ident y))) f) (Call (Ident v)))))))");
}
...
fn method_app_in_minus_unary() {
    test_block!("-Number.positive_infinity",
        @r#"(BodyBlock #((ExpressionStatement () (UnaryOprApp "-" (Call (PropertyAccess (Ident Number) positive_infinity))))))"#);
}
...
fn autoscope_operator() {
    ...
    test_block!("x : .. True",
        @r#"The autoscope operator must be applied to an identifier: (BodyBlock #((ExpressionStatement () (TypeAnnotated (Call (Ident x)) ":" (Call (App (Invalid) (Ident True)))))))"#);
}
...
fn type_signatures() {
    ...
    test_block!("val : Bool",
        @r#"(BodyBlock #((ExpressionStatement () (TypeAnnotated (Call (Ident val)) ":" (Call (Ident Bool))))))"#);
    test_module!("val : Bool\nval = True",
    ...
    test_module!("foo : [Integer | Text] -> (Integer | Text)",
        @r#"(BodyBlock #((TypeSignatureDeclaration ((Ident foo) ":" (OprApp (Array (OprApp (Call (Ident Integer)) (Ok "|") (Call (Ident Text))) #()) (Ok "->") (Group (OprApp (Call (Ident Integer)) (Ok "|") (Call (Ident Text)))))))))"#);
    test_module!("f a (b : Int) : Double",
        @r#"(BodyBlock #((TypeAnnotated (App (App (Ident f) (Call (Ident a))) (Group (TypeAnnotated (Call (Ident b)) ":" (Call (Ident Int))))) ":" (Ident Double))))"#);
    test_module!("f a (b = 1 : Int) : Double",
        @r#"(BodyBlock #((TypeAnnotated (NamedApp (App (Ident f) (Call (Ident a))) b (TypeAnnotated (Number () "1" ()) ":" (Call (Ident Int)))) ":" (Ident Double))))"#);
}

#[test]
fn type_annotations() {
    test_block!("val = x : Int",
        @r#"(BodyBlock #((Assignment () (Ident val) (TypeAnnotated (Call (Ident x)) ":" (Call (Ident Int))))))"#);
    test_block!("val = x : A : B : C",
        @r#"(BodyBlock #((Assignment () (Ident val) (TypeAnnotated (TypeAnnotated (TypeAnnotated (Call (Ident x)) ":" (Call (Ident A))) ":" (Call (Ident B))) ":" (Call (Ident C))))))"#);
    test_block!("val = foo (x : Int)",
        @r#"(BodyBlock #((Assignment () (Ident val) (Call (App (Ident foo) (Group (TypeAnnotated (Call (Ident x)) ":" (Call (Ident Int)))))))))"#);
    test_block!("(x : My_Type _)",
        @r#"(BodyBlock #((ExpressionStatement () (Group (TypeAnnotated (Call (Ident x)) ":" (Call (App (Ident My_Type) (TemplateFunction (Wildcard)))))))))"#);
    test_module!("x : List Int -> Int",
        @r#"(BodyBlock #((TypeSignatureDeclaration ((Ident x) ":" (OprApp (App (Ident List) (Ident Int)) (Ok "->") (Call (Ident Int)))))))"#);
    test_module!("p:Plus + m:Plus",
        @r#"(BodyBlock #((ExpressionStatement () (OprApp (TypeAnnotated (Call (Ident p)) ":" (Call (Ident Plus))) (Ok "+") (TypeAnnotated (Call (Ident m)) ":" (Call (Ident Plus)))))))"#);
}
...
fn case_expression() {
    ...
    test_block!(["case foo of", "    v:My_Type -> x", "    v:(My_Type _ _) -> x"].join("\n"),
        @r#"(BodyBlock #((ExpressionStatement () (CaseOf (Call (Ident foo)) #(((() (TypeAnnotated (Ident v) ":" (Call (Ident My_Type))) "->" (Call (Ident x)))) ((() (TypeAnnotated (Ident v) ":" (Group (Call (App (App (Ident My_Type) (TemplateFunction (Wildcard))) (TemplateFunction (Wildcard)))))) "->" (Call (Ident x)))))))))"#);
}
...
fn case_by_type() {
    ...
    test_case!("f:A->B -> x",
        @r#"(BodyBlock #((ExpressionStatement () (CaseOf (Call (Ident foo)) #(((() (TypeAnnotated (Ident f) ":" (OprApp (Ident A) (Ok "->") (Call (Ident B)))) "->" (Call (Ident x)))))))))"#);
    test_case!("f : A->B -> x",
        @r#"(BodyBlock #((ExpressionStatement () (CaseOf (Call (Ident foo)) #(((() (TypeAnnotated (Ident f) ":" (OprApp (Ident A) (Ok "->") (Call (Ident B)))) "->" (Call (Ident x)))))))))"#);
    test_case!("v : A -> x->x",
        @r#"(BodyBlock #((ExpressionStatement () (CaseOf (Call (Ident foo)) #(((() (TypeAnnotated (Ident v) ":" (Call (Ident A))) "->" (OprApp (Ident x) (Ok "->") (Call (Ident x))))))))))"#);
    test_case!("v : A -> x -> x",
        @r#"(BodyBlock #((ExpressionStatement () (CaseOf (Call (Ident foo)) #(((() (TypeAnnotated (Ident v) ":" (Call (Ident A))) "->" (OprApp (Ident x) (Ok "->") (Call (Ident x))))))))))"#);
    test_case!("v:A->x->x",
        @r#"(BodyBlock #((ExpressionStatement () (CaseOf (Call (Ident foo)) #(((() (TypeAnnotated (Ident v) ":" (Call (Ident A))) "->" (OprApp (Ident x) (Ok "->") (Call (Ident x))))))))))"#);
    test_case!("v:A->x",
        @r#"(BodyBlock #((ExpressionStatement () (CaseOf (Call (Ident foo)) #(((() (TypeAnnotated (Ident v) ":" (Call (Ident A))) "->" (Call (Ident x)))))))))"#);
    test_case!("v : A -> _ + x",
        @r#"(BodyBlock #((ExpressionStatement () (CaseOf (Call (Ident foo)) #(((() (TypeAnnotated (Ident v) ":" (Call (Ident A))) "->" (TemplateFunction (OprApp (Wildcard) (Ok "+") (Call (Ident x)))))))))))"#);
}
...
fn annotations() {
    test_module!("@on_problems P.g\nselect_columns : Text -> Table\nselect_columns text = to_table text",
        @r#"(BodyBlock #((Function () #(((on_problems (PropertyAccess (Ident P) g)) #(()))) ((Ident select_columns) ":" (OprApp (Ident Text) (Ok "->") (Call (Ident Table)))) () (Ident select_columns) #((() (Ident text) () ())) () (Call (App (Ident to_table) (Call (Ident text)))))))"#);
    test_module!("@a\n@b 1 + 1\nf x = x",
...
fn inline_builtin_annotations() {
    ...
    test_block!("@Tail_Call go\n a\n b",
        @"(BodyBlock #((ExpressionStatement () (AnnotatedBuiltin Tail_Call #() (ArgumentBlockApplication (Call (Ident go)) #((Call (Ident a)) (Call (Ident b))))))))");
...
fn space_required() {
    test_block!("foo = if cond.x else.y",
        @"Invalid macro invocation: (BodyBlock #((Assignment () (Ident foo) (Call (App (App (Invalid) (Call (PropertyAccess (Call (Ident cond)) x))) (Call (PropertyAccess (Call (Ident else)) y)))))))");
}
...
fn nonsense_inputs() {
    ...
    test_module!("if (asGuestValue\n  a",
        @"Invalid macro invocation: (BodyBlock #((ExpressionStatement () (ArgumentBlockApplication (Call (App (Invalid) (Invalid))) #((Call (Ident a)))))))");
    test_module!("foo(\n  a",
