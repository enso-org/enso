...
fn derive_finish_impl(input: proc_macro2::TokenStream) -> proc_macro2::TokenStream {
    ...
    quote! {
        impl #generics crate::syntax::Finish for #ident #generics where #flush_constraint Inner: crate::syntax::Finish {
...
fn derive_group_hierarchy_consumer_impl(
    ...
    let (flush_constraint, do_flush) = flush_syntax();
    quote! {
        impl #generics crate::syntax::expression::consumer::GroupHierarchyConsumer<'s> for #ident #generics
        where
            #flush_constraint
...
fn derive_scope_hierarchy_consumer_impl(
    ...
    quote! {
        impl #generics crate::syntax::expression::consumer::ScopeHierarchyConsumer for #ident #generics
        where
            #flush_constraint
...
fn derive_spacing_lookahead_token_consumer_impl(
    ...
    quote! {
        impl #generics crate::syntax::expression::whitespace::SpacingLookaheadTokenConsumer<'s> for #ident #generics
        where
            #flush_constraint
            Inner: crate::syntax::expression::whitespace::SpacingLookaheadTokenConsumer<'s>
        {
            fn push_token(&mut self, token: crate::syntax::Token<'s>, following_spacing: Option<crate::syntax::expression::whitespace::Spacing>) {
                #do_flush
...
fn derive_spacing_lookahead_tree_consumer_impl(
    ...
    quote! {
        impl #generics crate::syntax::expression::whitespace::SpacingLookaheadTreeConsumer<'s> for #ident #generics
        where
            #flush_constraint
            Inner: crate::syntax::expression::whitespace::SpacingLookaheadTreeConsumer<'s>
        {
            fn push_tree(&mut self, token: crate::syntax::Tree<'s>, following_spacing: Option<crate::syntax::expression::whitespace::Spacing>) {
                #do_flush
...
fn derive_apply_to_operand_impl(input: proc_macro2::TokenStream) -> proc_macro2::TokenStream {
    ...
    quote! {
        impl #generics crate::syntax::expression::reducer::ApplyToOperand<'s> for #ident #generics {
            fn apply_to_operand(self, operand: Option<crate::syntax::expression::types::Operand<'s>>) -> crate::syntax::expression::types::Operand<'s> {
