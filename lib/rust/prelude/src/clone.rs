...
impl_clone_ref_as_clone_no_from!(std::num::NonZeroU32);
impl_clone_ref_as_clone_no_from!(std::num::NonZeroU64);
impl_clone_ref_as_clone_no_from!(std::num::NonZeroUsize);
