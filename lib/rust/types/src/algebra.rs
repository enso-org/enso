...
// #[allow(missing_docs)]
// pub trait Dim1 {
//     /// The type of 1-dimensional projection of this type. For example, for `Vector4<f32>` this
// is     /// `f32`.
//     type Dim1Type;
//     fn x(&self) -> Self::Dim1Type;
// }
//
// /// Component setters and setters swizzling for 1-dimensional types.
// pub trait Dim1Setter: Dim1 {
//     fn set_x(&mut self, x: Self::Dim1Type);
// }
//
//
...
// #[allow(missing_docs)]
// pub trait Dim2: Dim1 {
//     /// The type of 2-dimensional projection of this type. For example, for `Vector4<f32>` this
// is     /// `Vector2<f32>`.
//     type Dim2Type;
...
// }
//
// /// Component setters and setters swizzling for 2-dimensional types.
// pub trait Dim2Setter: Dim2 {
//     fn set_y(&mut self, y: Self::Dim1Type);
//     fn set_xy(&mut self, value: Self::Dim2Type);
//     fn set_yx(&mut self, value: Self::Dim2Type);
// }
//
// /// Component accessors and swizzling for 3-dimensional types.
// #[allow(missing_docs)]
// pub trait Dim3: Dim2 {
//     /// The type of 3-dimensional projection of this type. For example, for `Vector4<f32>` this
// is     /// `Vector3<f32>`.
//     type Dim3Type;
...
// }
//
// /// Component setters and setters swizzling for 3-dimensional types.
// /// ```
// /// for t1 in &["x", "y", "z"] {
// ///     for t2 in &["x", "y", "z"] {
// ///         for t3 in &["x", "y", "z"] {
// ///             if t1 != t2 && t2 != t3 && t1 != t3 {
// ///                 println!("fn set_{}{}{}(&mut self, value: Self::Dim3Type);", t1, t2, t3);
// ///             }
// ///         }
// ///     }
// /// }
// /// assert_eq!(1, 2);
// /// ```
// pub trait Dim3Setter: Dim3 {
//     fn set_z(&mut self, value: Self::Dim1Type);
//     fn set_xz(&mut self, value: Self::Dim2Type);
//     fn set_zx(&mut self, value: Self::Dim2Type);
//     fn set_yz(&mut self, value: Self::Dim2Type);
//     fn set_zy(&mut self, value: Self::Dim2Type);
//
//     fn set_xyz(&mut self, value: Self::Dim3Type);
//     fn set_xzy(&mut self, value: Self::Dim3Type);
//     fn set_yxz(&mut self, value: Self::Dim3Type);
//     fn set_yzx(&mut self, value: Self::Dim3Type);
//     fn set_zxy(&mut self, value: Self::Dim3Type);
//     fn set_zyx(&mut self, value: Self::Dim3Type);
// }
//
// /// Component accessors and swizzling for 4-dimensional types.
// #[allow(missing_docs)]
// pub trait Dim4: Dim3 {
//     /// The type of 4-dimensional projection of this type. For example, for `Vector4<f32>` this
// is     /// `Vector4<f32>`.
//     type Dim4Type;
