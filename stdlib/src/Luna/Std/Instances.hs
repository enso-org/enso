...
type instance Luna.RuntimeRepOf ByteString       = Luna.AsNative ('Luna.ClassRep "Std.Base" "Binary")
type instance Luna.RuntimeRepOf (MVar Luna.Data) = Luna.AsNative ('Luna.ClassRep "Std.Base" "MVar")

type instance Luna.RuntimeRepOf Bool = Luna.AsClass Bool ('Luna.ClassRep "Std.Base" "Bool")
...
type instance Luna.RuntimeRepOf (a, b) = Luna.AsClass (a, b) ('Luna.ClassRep "Std.Base" "Tuple2")
...
type instance Luna.RuntimeRepOf (a, b, c) = Luna.AsClass (a, b, c) ('Luna.ClassRep "Std.Base" "Tuple3")
...
type instance Luna.RuntimeRepOf (a, b, c, d) = Luna.AsClass (a, b, c, d) ('Luna.ClassRep "Std.Base" "Tuple4")
...
type instance Luna.RuntimeRepOf (Maybe a) = Luna.AsClass (Maybe a) ('Luna.ClassRep "Std.Base" "Maybe")
...
type instance Luna.RuntimeRepOf (Either a b) = Luna.AsClass (Either a b) ('Luna.ClassRep "Std.Base" "Either")
...
type instance Luna.RuntimeRepOf [a] = Luna.AsClass [a] ('Luna.ClassRep "Std.Base" "List")
