...
pub struct CalledMethodInfo {
    /// Whether or not this call represents a static method. When a call is static, the potential
    /// associated `self` argument is not part of the access chain. Instead it is treated as an
    /// ordinary prefix argument.
    pub is_static:  bool,
