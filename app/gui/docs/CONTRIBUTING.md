...
- **Additional steps for Apple Silicon** If you are running Apple Silicon, you
  have to export an environment variable before compiling Rust dependencies.
  This should not be needed as soon as the
