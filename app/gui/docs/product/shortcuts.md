...
| <kbd>ctdl</kbd> + <kbd>shift</kbd> + <kbd>u</kbd>                  | Dump the suggestion database as JSON to the console. Available only in debug mode, and only if the component browser is open.  |
