  ...
  theme: {
    extend: {
      ...
      width: {
        ...
        'drive-created-at-column': 'var(--drive-created-at-column-width)',
        ...
        'drive-size-column': 'var(--drive-size-column-width)',
        'drive-created-by-column': 'var(--drive-created-by-column-width)',
      },
