...
import { type AssetId, type DirectoryId } from '#/services/Backend'
...
import { dropOperationBetweenCategories, isCloudCategory, isLocalCategory } from './Category'
              ...
              .map(([category, assetsByCategory]) => {
                ...
                return ask(AlertDialog, {
                  ...
                  children: createElement(Fragment, {
                    children: [
                      createElement(Text, {
                        children: getText('copyInsteadOfRestoring', category.label, to.label),
                      }),
                      createElement(Alert, {
                        variant: 'outline',
                        icon: 'copy2',
