...
import { useTextContext } from '#/components/AriaComponents/Text/hooks'
import type { TooltipElementType } from '#/components/AriaComponents/VisualTooltip'
import { useEventCallback } from '#/hooks/eventCallbackHooks'
import { mergeRefs } from '#/utilities/mergeRefs'
import type { VariantProps } from '#/utilities/tailwindVariants'
import * as React from 'react'
import { forwardRef, memo, type PropsWithChildren, type Ref, type RefObject } from 'react'
      ...
      return (
        <TextProvider value={{ isInsideTextComponent: true }}>
          <ElementType
            ...
            {...mergeProps<React.HTMLAttributes<HTMLElement>>()(
              ariaProps,
              targetProps,
              truncate === 'custom' ?
