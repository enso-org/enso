...
import type { AssetId, Backend, S3ObjectVersionId } from 'enso-common/src/services/Backend'
import {
  COLORS,
  LabelName,
  lChColorToCssColor,
...
/** Props for a {@link ManageAssetVersionTags}. */
 ...
 */
export default function ManageAssetVersionTags(props: ManageLabelsModalProps) {
...
/** Form for {@link ManageAssetVersionTags}. */
function ManageTagsForm(props: ManageAssetVersionTags) {
