...
import { FileExtensionFilter, Filter } from './fileExtensionFilter'

const filenameInputContents = defineModel<string>('filenameInputContents')
const fileExtensionInputContents = defineModel<string>('fileExtensionInputContents')
...
<template>
  <div class="FileNameBar">
    <input
      ...
      @keydown.enter.stop="emit('acceptCurrentFile')"
    />
    <div
