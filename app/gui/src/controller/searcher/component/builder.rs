...
impl List {
    ...
    /// `module_id`. In the returned [`List`], components passed to [`extend`] which have their
    /// parent module ID equal to `module_id` will be cloned into [`component::List::local_scope`].
