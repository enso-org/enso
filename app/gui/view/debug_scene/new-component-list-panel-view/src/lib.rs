...
// use ensogl_hardcoded_theme::application::component_browser::searcher::list_panel::section::
// column_grid; use ensogl_text as text;
// use ide_view_component_group::entry;
// use ide_view_component_group::entry::Kind;
...
//     }
//
//     fn get_section(&self, row: Row, column: Col) -> Option<(Range<Row>, Col, entry::Model)> {
...
//             style: entry::Style {
//                 color_intensities: entry::style::ColorIntensities {
//                     text: 1.0,
//                     background:
// style.get_number(theme::application::component_browser::component_group::
// background_color_intensity),                     dimmed:
// style.get_number(theme::application::component_browser::component_group::dimmed_color_intensity),
//                     icon_strong: 1.0,
//                     icon_weak:
// style.get_number(theme::application::component_browser::component_group::entry_list::icon::
// weak_color_intensity),                     hover_highlight:
// style.get_number(theme::application::component_browser::component_group::entry_list::icon::
// weak_color_intensity) * 0.8,                 },
...
//                 highlight_bold:
// style.get_number(theme::application::component_browser::component_group::entry_list::text::
// highlight_bold),                 header_shadow_size: 27.0,
//             },
//             dimmed_groups: default(),
//         };
//         let selection_params = entry::Params {
//             style: entry::Style {
//                 color_intensities: entry::style::ColorIntensities {
//                     text:
// style.get_number(theme::application::component_browser::component_group::
// background_color_intensity),                     background:
// style.get_number(theme::application::component_browser::component_group::
// selection_color_intensity),                     dimmed:
// style.get_number(theme::application::component_browser::component_group::dimmed_color_intensity),
//                     icon_strong:
// style.get_number(theme::application::component_browser::component_group::
// background_color_intensity),                     icon_weak:
// style.get_number(theme::application::component_browser::component_group::
// background_color_intensity),                     hover_highlight: default(),
//                 },
//                 ..params.style.clone()
//             },
//             dimmed_groups: default(),
...
//         let provider = Rc::new(EntryModelProvider { layout, colors: group_colors,
// local_scope_color:
// style.get_color(theme::application::component_browser::searcher::list_panel::
// favourites_section_base_color) });         let grid =
//             grid_view::scrollable::SelectableGridViewWithHeaders::<entry::View,
// entry::View>::new(                 &app,
//             );
...
//             let adjusted_left_top_pos = Vector2(origin_left_top_pos.x.floor(),
// origin_left_top_pos.y.floor());             let offset = adjusted_left_top_pos -
// origin_left_top_pos;             grid.set_position_xy(offset);
//         });
//         frp::extend! { network
//             grid.model_for_entry <+ grid.model_for_entry_needed.filter_map(f!((&(r, c))
// provider.get(r, c)));             header_frp.section_info <+
// header_frp.section_info_needed.filter_map(f!((&(r, c)) provider.get_section(r,c)));             
