...
impl Model {
    ...
    fn reload_style(&self) {
        ...
        self.outer_dom.set_size_tmp(Vector2(size.x, size.y));
        self.inner_dom.set_size_tmp(Vector2(size.x - padding, size.y - padding - PADDING_TOP));
...
impl View {
    ...
    fn init(self, app: &Application) -> Self {
        ...
        frp::extend! { network
            ...
            eval visualization.set_size_tmp  ((size) model.set_size_tmp(*size));
