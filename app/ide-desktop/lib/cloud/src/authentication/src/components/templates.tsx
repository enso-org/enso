        ...
        >
            {template.templateName ? (
                <div
                    ...
                    className="flex flex-col justify-end h-full w-full rounded-lg overflow-hidden text-white text-left bg-cover"
                >
                ...
                <div className="flex h-full w-full rounded-lg border-2 border-dashed border-[#3E515F8F]">
