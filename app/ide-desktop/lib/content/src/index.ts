...
import { foo, App } from 'ensogl_app'
console.log(foo, App)
...
//     ensogl_app: RequestInfo
//     wasm_glue_url: RequestInfo
//     wasm_url: RequestInfo
// }) {
//     let wasm_glue_fetch = await fetch(config.wasm_glue_url)
//     let wasm_fetch = await fetch(config.wasm_url)
//     let app_fetch = await fetch(config.ensogl_app)
//     let loader = new loader_module.Loader([wasm_glue_fetch, wasm_fetch, app_fetch], config)
//
//     // TODO [mwu]
...
//     public wasm_url: string = '/assets/main-opt.wasm'
//     public wasm_glue_url: string = '/assets/main.js'
//     public ensogl_app: string = '/assets/app.js'
