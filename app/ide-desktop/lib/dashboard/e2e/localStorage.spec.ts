...
test.test('drive category', async ({ page }) => {
  await actions.expectNotClassActive(actions.locateRecentCategory(page))
  await actions.expectClassActive(actions.locateHomeCategory(page))
  await actions.expectNotClassActive(actions.locateTrashCategory(page))
  await actions.locateRecentCategory(page).click()
  await actions.expectClassActive(actions.locateRecentCategory(page))
  await actions.expectNotClassActive(actions.locateHomeCategory(page))
  await actions.expectNotClassActive(actions.locateTrashCategory(page))
  await actions.login({ page })
  await actions.expectClassActive(actions.locateRecentCategory(page))
  await actions.expectNotClassActive(actions.locateHomeCategory(page))
  ...
  await actions.expectNotClassActive(actions.locateRecentCategory(page))
  await actions.expectNotClassActive(actions.locateHomeCategory(page))
  await actions.expectClassActive(actions.locateTrashCategory(page))
  await actions.login({ page })
  await actions.expectNotClassActive(actions.locateRecentCategory(page))
  await actions.expectNotClassActive(actions.locateHomeCategory(page))
  await actions.expectClassActive(actions.locateTrashCategory(page))
