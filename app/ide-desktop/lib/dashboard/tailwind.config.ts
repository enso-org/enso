...
0 18px 80px 0 #0000001c`,
            'top-covered-lg': `0 -1px 1.4px -1.4px #00000003, 0 -2.4px 3.4px -3.4px #00000004, \
0 -4.5px 6.4px -6.4px #00000005, 0 -8px 11.4px -11.4px #00000006, 0 -15px 21.3px -21.3px #00000007, \
0 -36px 51px -51px #00000008`,
        },
        animation: {
