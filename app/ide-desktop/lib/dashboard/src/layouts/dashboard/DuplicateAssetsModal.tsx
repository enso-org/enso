  ...
  return (
    <Modal centered className="absolute bg-dim">
      <form
        ...
        tabIndex={-1}
        className="relative flex flex-col gap-2 rounded-default pointer-events-auto w-96 p-4 pt-2 before:inset-0 before:absolute before:rounded-default before:bg-selected-frame before:backdrop-blur-default before:w-full before:h-full"
        onKeyDown={event => {
          if (event.key !== 'Escape') {
      ...
      >
        ...
        {nonConflictingCount > 0 && (
          <div className="relative flex flex-col gap-0.5">
            ...
            <button
              type="button"
              className="button relative self-start bg-selected-frame rounded-full"
