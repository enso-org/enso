...
import * as appInfo from '@/util/appInfo'
...
import type * as assetSettingsPanel from '@/dashboard/assetSettingsPanel'
import * as pageSwitcher from '@/dashboard/pageSwitcher'
import type * as spinner from '@/dashboard/spinner'
import CategorySwitcher, * as categorySwitcher from '@/dashboard/categorySwitcher'
import AssetsTable from '@/dashboard/assetsTable'
import DriveBar from '@/dashboard/driveBar'
