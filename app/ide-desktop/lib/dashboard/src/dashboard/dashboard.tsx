...
import * as localBackendModule from '@/util/localBackend'
...
import Chat, * as chat from '@/dashboard/chat'
import AssetSettingsPanel from '@/dashboard/assetSettingsPanel'
import ChatPlaceholder from '@/dashboard/chatPlaceholder'
import Drive from '@/dashboard/drive'
import Editor from '@/dashboard/editor'
import Home from '@/dashboard/home'
import TheModal from '@/dashboard/theModal'
