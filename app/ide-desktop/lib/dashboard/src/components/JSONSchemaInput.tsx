          ...
          if ('format' in schema && schema.format === 'enso-secret') {
            ...
            children.push(
              <input
                ...
                size={1}
                className={`text rounded-full w-data-link-text-input px-input-x bg-transparent border disabled:opacity-disabled read-only:opacity-read-only read-only:cursor-not-allowed ${
