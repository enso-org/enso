...
export class HttpResponse {
  ...
  /** Deserializes the HTTP response body as JSON, to the specified type. */
...
/** An HTTP request that is guaranteed to also have the URL it will be send to and an initialized
 * map of {@link Headers}.
 *
