...
/** `+`-shaped icon in a circle, representing creation of an item. */
export const CIRCLED_ADD_ICON = (
...
export const ADD_ICON = (
    ...
    >
        <rect x={11} y={6} width={2} height={12} fill="currentColor" opacity={0.66} />
        <rect x={6} y={11} width={12} height={2} fill="currentColor" opacity={0.66} />
    </svg>
)
