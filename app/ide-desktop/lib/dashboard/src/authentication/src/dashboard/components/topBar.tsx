...
export default function TopBar(props: TopBarProps) {
    ...
    return (
        <div
            className={`relative z-3 ml-4.75 mr-2.25 flex h-8 gap-6 ${
        ...
        >
            ...
            {page !== pageSwitcher.Page.editor && (
                <>
                    <div className="search-bar absolute left-1/2 flex h-8 w-98.25 min-w-31.5 -translate-x-1/2 items-center gap-2.5 rounded-full bg-frame px-2 text-primary">
                        ...
                        <input
                            ...
                            className="h-6 grow bg-transparent py-px leading-5"
                        />
                    </div>
                    <div className="grow" />
                </>
