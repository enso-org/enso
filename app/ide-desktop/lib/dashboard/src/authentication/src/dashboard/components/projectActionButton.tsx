        ...
        <>
          <button onClick={handleOpenProject}>
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="m10.04 7.34 6 3.85a1 1 0 0 1 0 1.68l-6 3.85a1 1 0 0 1-1.54-.84v-7.7a1 1 0 0 1 1.54-.84Z" fill="#3E515F" fillOpacity=".8"/>
              <rect x="1.5" y="1.5" width="21" height="21" rx="10.5" stroke="#3E515F" strokeOpacity="0.08" strokeWidth="3"/>
            </svg>
          </button>
        </>
      );
