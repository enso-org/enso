...
export default function Debug(props: DebugProps) {
  const { monitorProps = false, monitorRender = false, children } = props
  ...
  const typeName = typeof typeRaw === 'function' ? typeRaw.name : String(children.type)
  ...
  if (monitorRender) {
    console.group(`[Debug(${typeName})] Rendering`, Component, patchedChildProps)
  }
