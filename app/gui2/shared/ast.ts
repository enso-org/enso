...
import { sourceRangeKey, type ExprId, type SourceRange, type SourceRangeKey } from './yjsModel'
...
export const ROOT_ID = `Root` as SyncId
...
/** @internal */
export function isTokenId(t: SyncTokenId | SyncId | Ast | Owned<Ast> | Owned): t is SyncTokenId {
...
export abstract class MutableAst extends Ast {
  ...
  replaceValue<T extends MutableAst>(replacement: Owned<T>): Owned<typeof this> {
    ...
    replacement.setExprId(old.exprId)
    old.setExprId(newAstId())
    return old
  }
