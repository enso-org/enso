...
export default function Login() {
  ...
  const registrationPath =
    localBackend != null ?
      (`https://${CLOUD_DASHBOARD_DOMAIN}/registration?${newQuery}` as const)
    : (`/registration?${newQuery}` as const)
    ...
    >
      ...
      >
        ...
        <div className="flex w-full flex-col">
          ...
          <Button
            variant="link"
            href={`/forgot-password?${new URLSearchParams({ email: emailInput }).toString()}`}
            size="small"
            className="self-end"
          >
