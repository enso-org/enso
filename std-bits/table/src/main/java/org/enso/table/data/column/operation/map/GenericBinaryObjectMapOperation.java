...
public abstract class GenericBinaryObjectMapOperation<
  ...
  public Storage<?> runBinaryMap(
      InputStorageType storage, Object arg, MapOperationProblemAggregator problemBuilder) {
  ...
  public Storage<?> runZip(
      InputStorageType storage, Storage<?> arg, MapOperationProblemAggregator problemBuilder) {
