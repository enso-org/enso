...
public class AddRunning {
    ...
    public static Storage<Double> create_running(
        ...
        var ret
                = new DoubleStorage(
                        factory.result, sourceColumn.getSize(), factory.isNothing);
    ...
    private static class RunningIteratorFactoryImpl implements RunningIteratorFactory {
        ...
        RunningIteratorFactoryImpl(Statistic statistic, Column sourceColumn, ProblemAggregator problemAggregator) {
