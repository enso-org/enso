...
public class NumberParser extends IncrementalDatatypeParser {
  ...
  private static Pattern getPattern(boolean allowDecimal, boolean allowCurrency, boolean allowScientific,
                                    boolean trimValues, int index) {
  ...
  private static Pattern getPattern(boolean allowDecimal, boolean allowCurrency, boolean allowScientific,
                                    boolean trimValues, int patternIndex, String separators) {
    ...
    var INTEGER = "(?<integer>(\\d*)" + (separators.length() == 1 ? "" : "|(\\d{1,3}([" + separators.charAt(0) +
        "]\\d{3})*)") + ")";
   ...
   */
  public static NumberParser createIntegerParser(boolean allowCurrency, boolean allowLeadingZeros, boolean trimValues
   ...
   */
  public static NumberParser createAutoDecimalParser(boolean allowCurrency, boolean allowLeadingZeros,
                                                     boolean trimValues, boolean allowScientific) {
   ...
   */
  public static NumberParser createFixedDecimalParser(boolean allowCurrency, boolean allowLeadingZeros,
                                                      boolean trimValues, boolean allowScientific,
    ...
    return new NumberParser(true, allowCurrency, allowLeadingZeros, trimValues, allowScientific,
        thousandSeparator + decimalSeparator);
  }

  private NumberParser(boolean allowDecimal, boolean allowCurrency, boolean allowLeadingZeros, boolean trimValues,
                       boolean allowScientific, String separators) {
   ...
   * separators are used) and then paired with on of the valid patterns for the given parser.
   */
