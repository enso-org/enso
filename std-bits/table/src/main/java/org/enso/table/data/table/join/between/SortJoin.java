...
public class SortJoin implements JoinStrategy {
    ...
    /**
     * Adds all pairs of rows from the left index matching the right index to
     * the builder, and reports the match count.
     *
     * <p>
     * It also marks any of the left rows that were matched, in the
     * {@code matchedLeftRows}.
     */
