...
public final class StringComparators extends GenericComparators<String> {
  ...
  public static final StringComparators NEQ = new StringComparators((a, b) -> !Text_Utils.equals(a, b), false);
  public static final StringComparators LT = new StringComparators((a, b) -> Text_Utils.compare_normalized(a, b) < 0);
  public static final StringComparators LTE = new StringComparators((a, b) -> Text_Utils.compare_normalized(a, b) <= 0);
  public static final StringComparators GT = new StringComparators((a, b) -> Text_Utils.compare_normalized(a, b) > 0);
  public static final StringComparators GTE = new StringComparators((a, b) -> Text_Utils.compare_normalized(a, b) >= 0);

  private StringComparators(BiPredicate<String, String> comparator) {
