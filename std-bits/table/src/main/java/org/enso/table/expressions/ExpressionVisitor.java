...
public interface ExpressionVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code nullOrNothing}
	...
	/**
	 * Visit a parse tree produced by the {@code excelString}
	 * labeled alternative in {@link ExpressionParser#value}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code pythonString}
	 * labeled alternative in {@link ExpressionParser#value}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
