...
public class DateTimeSubtraction<T extends Temporal> extends BinaryOperationBase<T, Object> {
  public static final DateTimeSubtraction<ZonedDateTime> DATE_TIME = new DateTimeSubtraction<>(DateTimeType.INSTANCE);
  public static final DateTimeSubtraction<LocalTime> TIME_OF_DAY = new DateTimeSubtraction<>(TimeOfDayType.INSTANCE);
  ...
  @Override
  protected ColumnStorage<Object> applyNullMap(ColumnStorage<?> left, Object rightValue, MapOperationProblemAggregator problemAggregator) {
