...
public interface ExpressionListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code excelString}
	 * labeled alternative in {@link ExpressionParser#value}.
	 * @param ctx the parse tree
	 */
	void enterExcelString(ExpressionParser.ExcelStringContext ctx);
	/**
	 * Exit a parse tree produced by the {@code excelString}
	 * labeled alternative in {@link ExpressionParser#value}.
	 * @param ctx the parse tree
	 */
	void exitExcelString(ExpressionParser.ExcelStringContext ctx);
	/**
	 * Enter a parse tree produced by the {@code pythonString}
	 * labeled alternative in {@link ExpressionParser#value}.
	 * @param ctx the parse tree
	 */
	void enterPythonString(ExpressionParser.PythonStringContext ctx);
	/**
	 * Exit a parse tree produced by the {@code pythonString}
	 * labeled alternative in {@link ExpressionParser#value}.
	 * @param ctx the parse tree
	 */
