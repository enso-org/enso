...
/**
 * A pluggable strategy that can be used as the inner strategy for a join if there are no more join conditions to
 * process - so all rows are matched with each other within a given group.
 */
