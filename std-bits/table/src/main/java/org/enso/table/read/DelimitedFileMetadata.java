 ...
 *     {@code GENERATE_HEADERS} is used or if {@code INFER} is used and no headers were found inside
 *     the file.
 * @param hasAnyContent Flag indicating if the file contained any data.
 * @param effectiveLineSeparator If it was provided explicitly at construction, the selected
 *     separator is used. If the initial separator was set to {@code null}, the separator detected
 *     from file contents will be returned.
 */
