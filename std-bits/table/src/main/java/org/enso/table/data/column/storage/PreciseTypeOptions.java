 ...
 * @param shrinkText specifies if the method should look for the smallest possible text type that will fit the present values
 ...
 */
public record PreciseTypeOptions(boolean shrinkIntegers, boolean shrinkText, boolean wholeFloatsBecomeIntegers) {
  /* The default setting that should be fast to compute. */
  public static final PreciseTypeOptions DEFAULT =
      new PreciseTypeOptions(false, false,false);

  public static final PreciseTypeOptions SHRINK =
      new PreciseTypeOptions(true, true, true);
