...
public abstract class MapOperation<T, I extends Storage<? super T>> {
   ...
   */
  public abstract Storage<?> runMap(I storage, Object arg, MapOperationProblemBuilder problemBuilder);
   ...
   * @return the result of running the operation
   */
  public abstract Storage<?> runZip(I storage, Storage<?> arg, MapOperationProblemBuilder problemBuilder);
