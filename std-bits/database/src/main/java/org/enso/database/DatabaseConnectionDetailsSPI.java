...
public abstract class DatabaseConnectionDetailsSPI {
  ...
  /**
   * Returns an array of pairs, where the first element is the user facing connection name and the second element is a
   * string representing the code to insert to create a default connection instance. That code may contain `_`
   * placeholders for expected arguments.
   */
