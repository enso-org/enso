...
public class JDBCUtils {
   ...
   * <p>
   * Note that the only timezone information is based on the offset provided by the database, so only simple offset
   * timezones will be returned. No support for named timezones.
   */
   ...
   */
  public static void setZonedDateTime(PreparedStatement stmt, int columnIndex, ZonedDateTime zonedDateTime) throws SQLException {
