fn main() {
    ...
    let path_to_archive = std::env::var("ENSO_INSTALL_ARCHIVE_PATH").unwrap_or_else(|_| {
        // r"C:\Users\mwurb\Downloads\project-manager-bundle-2023.2.1-nightly.2023.11.
        // 24-macos-amd64.tar.gz"
        r"C:\Users\mwurb\enso-win-2023.2.1-dev.tar.gz".to_string()
    });
