...
- type Snowflake_Connection
    ...
    - create url:Standard.Base.Data.Text.Text properties:Standard.Base.Data.Vector.Vector credentials:(Standard.Database.Connection.Credentials.Credentials|Standard.Snowflake.Connection.Key_Pair_Credentials.Key_Pair_Credentials|Standard.Base.Enso_Cloud.Enso_Secret.Enso_Secret) make_new:Standard.Base.Any.Any data_link_setup:Standard.Database.Internal.Data_Link_Setup.Data_Link_Setup -> Standard.Snowflake.Snowflake_Connection.Snowflake_Connection
