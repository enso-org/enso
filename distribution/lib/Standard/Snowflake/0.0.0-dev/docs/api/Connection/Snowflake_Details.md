...
- type Snowflake_Details
    - Snowflake account:Standard.Base.Data.Text.Text= credentials:(Standard.Database.Connection.Credentials.Credentials|Standard.Snowflake.Connection.Key_Pair_Credentials.Key_Pair_Credentials)= database:Standard.Base.Data.Text.Text= schema:Standard.Base.Data.Text.Text= warehouse:Standard.Base.Data.Text.Text=
