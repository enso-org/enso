...
- type Spatial_Table
    ...
    - st_concave_hull self column:(Standard.Table.Column.Column|Standard.Table.Expression.Expression|Standard.Base.Data.Text.Text|Standard.Base.Data.Numbers.Integer)= as:Standard.Base.Data.Text.Text= ratio:Standard.Base.Data.Numbers.Float= allow_holes:Standard.Base.Data.Boolean.Boolean= -> Standard.Base.Any.Any
    - st_convex_hull self column:(Standard.Table.Column.Column|Standard.Table.Expression.Expression|Standard.Base.Data.Text.Text|Standard.Base.Data.Numbers.Integer)= as:Standard.Base.Data.Text.Text= -> Standard.Base.Any.Any
    ...
    - st_make_lines self column:(Standard.Table.Column.Column|Standard.Table.Expression.Expression|Standard.Base.Data.Text.Text|Standard.Base.Data.Numbers.Integer)= as:Standard.Base.Data.Text.Text= group_by:((Standard.Base.Data.Vector.Vector Standard.Base.Any.Any)|Standard.Base.Data.Text.Text|Standard.Base.Data.Numbers.Integer|Standard.Base.Data.Text.Regex.Regex)= order_by:((Standard.Base.Data.Vector.Vector Standard.Base.Any.Any)|Standard.Base.Data.Text.Text)= -> Standard.Base.Any.Any
    - st_make_polygons self column:(Standard.Table.Column.Column|Standard.Table.Expression.Expression|Standard.Base.Data.Text.Text|Standard.Base.Data.Numbers.Integer)= as:Standard.Base.Data.Text.Text= group_by:((Standard.Base.Data.Vector.Vector Standard.Base.Any.Any)|Standard.Base.Data.Text.Text|Standard.Base.Data.Numbers.Integer|Standard.Base.Data.Text.Regex.Regex)= order_by:((Standard.Base.Data.Vector.Vector Standard.Base.Any.Any)|Standard.Base.Data.Text.Text)= -> Standard.Base.Any.Any
