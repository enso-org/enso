...
- type In_Memory_Table
    - new columns:(Standard.Base.Data.Vector.Vector Standard.Base.Any.Any) -> (Standard.Table.Table.Table&Standard.Table.In_Memory_Table.In_Memory_Table)
...
- from_java_table java_table:Standard.Base.Any.Any -> (Standard.Table.Table.Table&Standard.Table.In_Memory_Table.In_Memory_Table)
