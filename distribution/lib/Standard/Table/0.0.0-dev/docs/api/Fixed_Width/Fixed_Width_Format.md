...
- type Fixed_Width_Format
    - Fixed_Width layout:Standard.Table.Fixed_Width.Fixed_Width_Format.Fixed_Width_Layout encoding:Standard.Base.Data.Text.Encoding.Encoding= row_limit:Standard.Table.Rows_To_Read.Rows_To_Read= on_invalid_rows:Standard.Table.Fixed_Width.Invalid_Fixed_Width_Rows.Invalid_Fixed_Width_Rows= on_empty_field:Standard.Table.Fixed_Width.On_Empty_Field.On_Empty_Field= value_formatter:(Standard.Table.Data_Formatter.Data_Formatter|Standard.Base.Nothing.Nothing)=
