...
- type In_Memory_Column
    ...
    - to_json_data self start:Standard.Base.Data.Numbers.Integer= length:Standard.Base.Data.Numbers.Integer= fallback:Standard.Base.Any.Any= -> Standard.Base.Data.Text.Text
