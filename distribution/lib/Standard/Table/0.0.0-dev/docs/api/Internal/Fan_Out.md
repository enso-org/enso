...
- fan_out_to_rows_and_columns_dynamic input_storage:Standard.Base.Any.Any function:Standard.Base.Any.Any at_least_one_row:Standard.Base.Any.Any column_names_for_row:Standard.Base.Any.Any column_builder:Standard.Base.Any.Any problem_builder:Standard.Base.Any.Any -> Standard.Base.Any.Any
- fan_out_to_rows_and_columns_fixed input_storage:Standard.Base.Any.Any function:Standard.Base.Any.Any at_least_one_row:Standard.Base.Data.Boolean.Boolean column_names:Standard.Base.Data.Vector.Vector column_builder:Standard.Base.Any.Any problem_builder:Standard.Base.Any.Any -> Standard.Base.Any.Any
