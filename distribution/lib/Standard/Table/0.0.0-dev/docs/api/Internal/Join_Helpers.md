...
- type Join_Condition_Resolver
    - Value left_at:Standard.Base.Any.Any right_at:Standard.Base.Any.Any make_equals:Standard.Base.Any.Any make_equals_ignore_case:Standard.Base.Any.Any make_between:Standard.Base.Any.Any
