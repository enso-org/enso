...
- type DuckDB_Connection
    ...
    - create_spatial_index self table:Standard.Base.Any.Any= column:Standard.Base.Data.Vector.Vector= as:Standard.Base.Data.Text.Text= replace_if_present:Standard.Base.Data.Boolean.Boolean= -> Standard.Base.Any.Any
