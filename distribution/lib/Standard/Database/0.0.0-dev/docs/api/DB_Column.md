...
- type DB_Column
    ...
    - zip self right:(Standard.Table.Column.Column|Standard.Table.Table.Table)= keep_unmatched:(Standard.Base.Data.Boolean.Boolean|Standard.Base.Any.Any)= right_prefix:Standard.Base.Data.Text.Text= on_problems:Standard.Base.Errors.Problem_Behavior.Problem_Behavior= -> Standard.Table.Table.Table
    - || self other:(Standard.Database.DB_Column.DB_Column|Standard.Base.Any.Any) -> Standard.Database.DB_Column.DB_Column
