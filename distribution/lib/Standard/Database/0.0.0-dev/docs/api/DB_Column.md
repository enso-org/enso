...
- type DB_Column
    ...
    - regex_match self pattern:(Standard.Database.DB_Column.DB_Column|Standard.Base.Data.Text.Text|Standard.Base.Any.Any) -> Standard.Database.DB_Column.DB_Column
