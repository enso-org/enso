...
- type JDBC_Connection
    - batch_insert self insert_template:Standard.Base.Any.Any jdbc_value_setter_database_name:Standard.Base.Any.Any jdbc_value_setter_class_name:Standard.Base.Any.Any java_columns:Standard.Base.Any.Any batch_size:Standard.Base.Any.Any date_time_with_timezone:Standard.Base.Any.Any expected_type_hints:Standard.Base.Any.Any use_sql_type_hints_for_null_values:Standard.Base.Any.Any supports_separate_nan:Standard.Base.Any.Any supports_infinity:Standard.Base.Any.Any num_rows:Standard.Base.Any.Any -> Standard.Base.Any.Any
