...
- type JDBC_Connection
    - Value connection_resource:Standard.Base.Any.Any operation_synchronizer:Standard.Base.Any.Any sql_ex:Standard.Base.Any.Any=
...
- handle_sql_errors self ~action:Standard.Base.Any.Any related_query:Standard.Base.Any.Any= sql_exception:Standard.Base.Any.Any= -> Standard.Base.Any.Any
