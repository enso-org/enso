...
- type Data_Link_With_Input_Stream
    ...
    - with_input_stream self open_options:Standard.Base.Data.Vector.Vector action:(Standard.Base.System.Input_Stream.Input_Stream -> Standard.Base.Any.Any) -> Standard.Base.Any.Any
- type Data_Link_With_Output_Stream
    - Value underlying:Standard.Base.Any.Any
    - find data_link_instance:Standard.Base.Any.Any if_not_supported:Standard.Base.Any.Any= -> Standard.Base.Any.Any
    - with_output_stream self open_options:Standard.Base.Data.Vector.Vector action:(Standard.Base.System.Output_Stream.Output_Stream -> Standard.Base.Any.Any) -> Standard.Base.Any.Any
