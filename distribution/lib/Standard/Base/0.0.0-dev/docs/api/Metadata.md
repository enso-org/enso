...
- type Choice
    - Option label:Standard.Base.Data.Text.Text value:(Standard.Base.Data.Text.Text|(Standard.Base.Data.Vector.Vector Standard.Base.Metadata.Choice))= parameters:(Standard.Base.Data.Vector.Vector Standard.Base.Any.Any)= icon:Standard.Base.Data.Text.Text=
...
- type Widget
    ...
    - Secret_Browse display:Standard.Base.Metadata.Display=
