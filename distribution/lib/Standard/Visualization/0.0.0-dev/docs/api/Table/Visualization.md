...
- make_json_for_table dataframe:Standard.Base.Any.Any max_rows:Standard.Base.Any.Any all_rows_count:Standard.Base.Any.Any include_index_col:Standard.Base.Any.Any is_db_table:Standard.Base.Any.Any -> Standard.Base.Any.Any
