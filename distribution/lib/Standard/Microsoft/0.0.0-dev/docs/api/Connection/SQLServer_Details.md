...
- type SQLServer_Details
    - SQLServer host:Standard.Base.Data.Text.Text= credentials:Standard.Database.Connection.Credentials.Credentials= port:Standard.Base.Data.Numbers.Integer= database:Standard.Base.Data.Text.Text=
