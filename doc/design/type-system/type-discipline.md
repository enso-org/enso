...
- Type definitions are, by default, desugared to open rows.
...
- Type definitions that do include data members are given autogenerated
  constructors.
- The desugaring of type definitions will include default implementations and
  values.
