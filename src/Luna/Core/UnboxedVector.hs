...
derivingUnbox "UniCore"
    ...
    [|  \x -> case x of UVar (Var n) -> (True, n, 0); UAcc (Acc (ULink (Keyx n1)) (ULink (Keyx n2))) -> (False, n1, n2) |]
    [|  \(b, n1, n2) -> if b then UVar (Var n1) else UAcc (Acc (ULink (Keyx n1)) (ULink (Keyx n2)))                     |]
