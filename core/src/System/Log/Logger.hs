...
import System.Log.Logger.Class    as X ( Logger, IsLogger, MonadLogging, runLogger, runLoggers, tagged )
...
import System.Log.Logger.Filter   as X ( FilterLogger, runFilterLogger
                                       , StaticTagFilterLogger, runStaticTagFilterLogger
                                       , DynamicTagFilterLogger, runDynamicTagFilterLogger, runDynamicTagFilterLogger' )
