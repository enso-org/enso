...
import Luna.IR.Expr as X hiding (Number, String, FmtString, Acc, App, Lam, Unify, Seq, Match, Monadic, Cons, Var, FieldLens, Grouped, Blank, Star, Missing, ASGFunction, FunctionSig, RootedFunction, ASGRootedFunction, ClsASG, Unit, UnitProxy, UnresolvedImport, UnresolvedImportSrc, World, Typed, RecASG, FieldASG, Invalid, List, Tuple, LeftSection, RightSection, AccSection, Disabled, Marker, Marked, Metadata, Update, Modify)
