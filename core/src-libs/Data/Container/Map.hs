module Data.Container.Map where

import Prelude
import Data.Container.Mono


-- Maybe we should finish this approach to make possible creating Names Intmaps, like: IntMap Name



class IsMap a where
    lookup :: Key a -> a -> Maybe (Item a)
    -- insertWithKey ::
