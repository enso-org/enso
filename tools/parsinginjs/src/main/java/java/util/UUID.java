...
public final class UUID implements java.io.Serializable, Comparable<UUID> {
    ...
    /**
     * Constructs a new {@code UUID} using the specified data. null     {@code
    ...
    public static UUID nameUUIDFromBytes(byte[] name) {
        throw new SecurityException("nameUUIDFromBytes");
    }
    ...
    private static long parseLong(CharSequence txt, int begin, int end, int radix) {
        var sub = txt.subSequence(begin, end).toString();
        return Long.parseLong(sub, radix);
    }
    ...
    public String toString() {
        ...
        formatUnsignedLong0UTF16(leastSigBits, 4, buf, 24, 12);
        formatUnsignedLong0UTF16(leastSigBits >>> 48, 4, buf, 19, 4);
        formatUnsignedLong0UTF16(mostSigBits, 4, buf, 14, 4);
        formatUnsignedLong0UTF16(mostSigBits >>> 16, 4, buf, 9, 4);
        formatUnsignedLong0UTF16(mostSigBits >>> 32, 4, buf, 0, 8);
