...
[VSCode with Enso extension](../tools/enso4igv/README.md).

<!--
TBD: Move to separate document.

#### Using IntelliJ

IntelliJ is a popular Java, Scala & co. IDE. What follows is a basic set of instructions for
