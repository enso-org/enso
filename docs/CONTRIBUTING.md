...
```bash
_JAVA_OPTIONS='-agentlib:jdwp=transport=dt_socket,server=n,address=5005' enso --run test/Base_Tests/src/Data/Time/Duration_Spec.enso
```
...
`_JAVA_OPTIONS` environment variable. There are also Enso-specific assertions
