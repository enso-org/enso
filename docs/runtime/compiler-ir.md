...
`--add-exports jdk.graal.compiler/org.graalvm.graphio=org.enso.runtime.compiler.dump.igv`
...
```
$ env JAVA_OPTS='--add-exports jdk.graal.compiler/org.graalvm.graphio=org.enso.runtime.compiler.dump.igv' ./built-distribution/*/bin/enso --vm.D enso.compiler.dumpIr=Vector --no-ir-caches --run tmp.enso
```
