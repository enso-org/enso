...
To fix that, individual services have to be placed in separate subprojects of
`runtime` and later META-INF registrations are concatenated in the final uber
jar.
