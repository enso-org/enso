...
find ../../core/src -name '*.hs' | xargs bin/graphmod -i ../../core/src -q --no-cluster                                           > dist/core.dot
find ../../core/src -name '*.hs' | xargs bin/graphmod -i ../../core/src -C "Luna.IR.Expr" -r "Luna.Prelude" > dist/core-overview.dot

echo "Making core vis"
dot -Tpng -Gdpi=1000 dist/core-overview.dot > dist/core-overview.png
dot -Tpng -Gdpi=1000 dist/core.dot > dist/core.png
