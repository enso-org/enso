module Luna.Test.Package.Configuration.GlobalSpec where
...
import Luna.Test.Package.Configuration.YamlTestUtils ( shouldDecodeAs
                                                     , shouldNotDecode
                                                     , shouldGenerate )
